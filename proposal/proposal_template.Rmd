...
Counties_by_LEP <- read_csv("~/R/Team-E-T/data/Counties_by_LEP.csv")
...
```{r glimpse_data}
glimpse(Counties_by_Race)
glimpse(Counties_by_Ethnicity)
glimpse(Counties_by_FI_2019)
glimpse(Counties_by_FI_March21)
glimpse(Counties_by_VLFI_March21)
glimpse(Counties_by_LEP)
```
# Data Analysis Plan
